...
namespace basic_13 {
    class Program {
        ...
        static void Main (string[] args) {
            ...
            FindMax (new int[] { 0, -2, 7, 1 });
            GetAverage (new int[] { 3, 6, 1, 4, 6, 10 });
            OddArray ();
            GreaterThanY (new int[] { 1, 2, 3, 4, 5 }, 2);
            SquareArrayValues (new int[] { 5, 4, 3, 2, 1 });
            EliminateNegatives (new int[] { 1, -3, 4, 2, -5, 5, -9 });
            MinMaxAverage (new int[] { 4, 5, 1, 3, 7, 4 });
            ShiftValues (new int[] { 5, 3, 9, 1, 1, 4 });
